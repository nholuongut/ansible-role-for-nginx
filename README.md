...
Create the child template in the path you configured above and extend `nholuong.nginx` template file relative to your `playbook.yml`.

```
{% extends 'roles/nholuong.nginx/templates/nginx.conf.j2' %}
